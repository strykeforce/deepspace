...
public class VisionSubsystem extends Subsystem implements Item {
  ...
  private static final double GLUE_CORRECTION_FACTOR_LEFT = -0.1398; // FROM CAMERA CAL -1.25 comp
  ...
  private static final double CAMERA_RANGE_SLOPE_LEFT = 1.0428; // 0.8259
  private static final double CAMERA_RANGE_OFFSET_LEFT = -4.8461; // -5.6325
