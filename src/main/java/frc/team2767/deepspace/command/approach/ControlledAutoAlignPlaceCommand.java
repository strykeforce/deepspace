...
public class ControlledAutoAlignPlaceCommand extends Command {
  ...
  public ControlledAutoAlignPlaceCommand() {
    requires(DRIVE);
  ...
  protected void initialize() {
    gyroAngle = Math.IEEEremainder(DRIVE.getGyro().getAngle(), 360.0);

    // given left side of robot is placing:
