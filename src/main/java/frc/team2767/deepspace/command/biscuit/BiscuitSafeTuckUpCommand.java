...
public class BiscuitSafeTuckUpCommand extends ConditionalCommand {
  ...
  public BiscuitSafeTuckUpCommand() {
    super(
        new CommandGroup() {
          {
        ...
        new BiscuitSetPositionCommand(BiscuitSubsystem.kUpPositionDeg));
  }
